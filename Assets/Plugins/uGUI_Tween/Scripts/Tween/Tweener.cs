...
namespace uTools
{
    public abstract class Tweener : MonoBehaviour
    {
        ...
        public System.Action onUpdateCallback = null;
        ...
        void SetOnFinished(UnityEvent finishedCallBack) { onFinished = finishedCallBack; }
        ...
        public void SetOnFinished(System.Action finishedCallBack) 
        {
            if(selfEvt == null)
                selfEvt = new UnityEngine.Events.UnityEvent();
